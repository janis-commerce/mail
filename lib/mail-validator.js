...
module.exports = class MailValidator {
	...
	validateRequiredFields() {
		...
		if(typeof this.mail.templateCode === 'undefined' && typeof this.mail.to === 'undefined')
			throw new MailError('Empty field: to property is required when templateCode is not set', MailError.codes.REQUIRED_FIELD_MISSING);

		if(typeof this.mail.templateCode === 'undefined' && typeof this.mail.subject === 'undefined')
			throw new MailError('Empty field: subject property is required when templateCode is not set', MailError.codes.REQUIRED_FIELD_MISSING);
	...
	validateFieldTypes() {
		...
		// Should be a string
		if(typeof this.mail.replyTo !== 'undefined' && typeof this.mail.replyTo !== 'string')
		...
		// Should be a string
		if(typeof this.mail.userCreated !== 'undefined' && typeof this.mail.userCreated !== 'string')
			throw new MailError('Invalid mail: userCreated property must be a string', MailError.codes.INVALID_FIELD_TYPE);
	}
};
